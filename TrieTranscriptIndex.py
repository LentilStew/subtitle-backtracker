...
class TrieTranscriptIndex:
    ...
    def create_trie(cls, transcripts_paths, trie_path=None):
        ...
        trie = marisa_trie.RecordTrie(config["youtube"]["MARISA_TRIE_INDEX_FMT"], key_val_pairs)
    ...
    def create_trie_transcript(cls, transcripts_paths, trie_path=None, save_index=True,fmt="11s"):
        trie = TrieTranscriptIndex.create_trie(transcripts_paths, trie_path, save_index,fmt=fmt)
